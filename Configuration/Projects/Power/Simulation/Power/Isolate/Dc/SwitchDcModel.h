...
class SwitchDcModelBattery : public SwitchDcModel
{
public:
    SwitchDcModelBattery();
    virtual ~SwitchDcModelBattery();
    // Initialize simulation model
    virtual void InitializeItem(void);
    // Do simulation every 100ms (slotCounter_100ms: Slot ID for simulation task)
    virtual void DoSimulation_100ms(Int32 slotCounter_100ms);
...
class SwitchDcModelInverter : public SwitchDcModel
{
public:
    SwitchDcModelInverter();
    virtual ~SwitchDcModelInverter();
    // Initialize simulation model
    virtual void InitializeItem(void);
    // Do simulation every 100ms (slotCounter_100ms: Slot ID for simulation task)
    virtual void DoSimulation_100ms(Int32 slotCounter_100ms);
