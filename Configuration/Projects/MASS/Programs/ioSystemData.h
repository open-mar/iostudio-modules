...
typedef enum
{
    ...
    Duid_Steer_CpA_TakeCommand = 294,
    Duid_Steer_CpA_ModeDp = 295,
    Duid_Steer_CpA_ModeRiver = 296,
    Duid_Steer_CpA_ModeTrack = 297,
    Duid_Steer_CpA_ModeWork = 298,
    Duid_Steer_CpA_ModeAuto = 299,
    Duid_Steer_CpA_ModeStandby = 300,
    Duid_Steer_CpA_SteerMode = 301,
    Duid_Steer_CpA_Release = 302,
    Duid_Steer_CpA_OnChangeCommand = 303,
    Duid_Steer_CpA_OnChangeSteerMode = 304,
    Duid_Steer_CpA_LeftSmall = 305,
    Duid_Steer_CpA_MidZero = 306,
    Duid_Steer_CpA_RightSmall = 307,
    Duid_Steer_CpA_LeftBig = 308,
    Duid_Steer_CpA_RightBig = 309,
    Duid_Steer_CpA_EncoderNumber = 310,
} ioSystemDataType;
class ioSystemData
{
public:
