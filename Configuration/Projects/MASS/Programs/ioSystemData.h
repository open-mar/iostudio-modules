...
typedef enum
{
    ...
    Duid_Steer_ApM_RudderAngleMeas = 245,
    Duid_Steer_ApM_FrontThrustMeas = 246,
    Duid_Steer_ApM_RateOfTurnMeas = 247,
    Duid_Steer_ApM_HeadingMeas = 248,
    Duid_Steer_ApM_FrontThrustRef = 249,
    Duid_Steer_ApM_OnChangeRef = 250,
    Duid_Steer_ApM_HeadingRef = 251,
    Duid_Steer_ApM_RateOfTurnRef = 252,
    Duid_Steer_ApM_RudderAngleRef = 253,
    Duid_Steer_ApM_OnRequestSteerData = 254,
    Duid_Steer_ApM_OnChangeCompass = 255,
    Duid_Steer_ApM_OnChangeRudder = 256,
    Duid_Steer_ApM_OnChangeThrust = 257,
    Duid_Steer_ApM_EngineRpmMeas = 258,
    Duid_Steer_ApM_EngineRpmRef = 259,
    Duid_Steer_ApM_OnChangeEngine = 260,
    Duid_Steer_ApA_RudderAngleMeas = 261,
    Duid_Steer_ApA_FrontThrustMeas = 262,
    Duid_Steer_ApA_RateOfTurnMeas = 263,
    Duid_Steer_ApA_HeadingMeas = 264,
    Duid_Steer_ApA_FrontThrustRef = 265,
    Duid_Steer_ApA_OnChangeRef = 266,
    Duid_Steer_ApA_HeadingRef = 267,
    Duid_Steer_ApA_RateOfTurnRef = 268,
    Duid_Steer_ApA_RudderAngleRef = 269,
    Duid_Steer_ApA_OnRequestSteerData = 270,
    Duid_Steer_ApA_OnChangeCompass = 271,
    Duid_Steer_ApA_OnChangeRudder = 272,
    Duid_Steer_ApA_OnChangeThrust = 273,
    Duid_Steer_ApA_EngineRpmMeas = 274,
    Duid_Steer_ApA_EngineRpmRef = 275,
    Duid_Steer_ApA_OnChangeEngine = 276,
    Duid_Steer_CpM_TakeCommand = 277,
    Duid_Steer_CpM_ModeDp = 278,
    Duid_Steer_CpM_ModeRiver = 279,
    Duid_Steer_CpM_ModeTrack = 280,
    Duid_Steer_CpM_ModeWork = 281,
    Duid_Steer_CpM_ModeAuto = 282,
    Duid_Steer_CpM_ModeStandby = 283,
    Duid_Steer_CpM_SteerMode = 284,
    Duid_Steer_CpM_Release = 285,
    Duid_Steer_CpM_OnChangeCommand = 286,
    Duid_Steer_CpM_OnChangeSteerMode = 287,
    Duid_Steer_CpM_LeftSmall = 288,
    Duid_Steer_CpM_MidZero = 289,
    Duid_Steer_CpM_RightSmall = 290,
    Duid_Steer_CpM_LeftBig = 291,
    Duid_Steer_CpM_RightBig = 292,
    Duid_Steer_CpM_EncoderNumber = 293,
    Duid_Steer_CpM_ActiveStation = 294,
    Duid_Steer_CpM_StationMode = 295,
    Duid_Steer_CpA_TakeCommand = 296,
    Duid_Steer_CpA_ModeDp = 297,
    Duid_Steer_CpA_ModeRiver = 298,
    Duid_Steer_CpA_ModeTrack = 299,
    Duid_Steer_CpA_ModeWork = 300,
    Duid_Steer_CpA_ModeAuto = 301,
    Duid_Steer_CpA_ModeStandby = 302,
    Duid_Steer_CpA_SteerMode = 303,
    Duid_Steer_CpA_Release = 304,
    Duid_Steer_CpA_OnChangeCommand = 305,
    Duid_Steer_CpA_OnChangeSteerMode = 306,
    Duid_Steer_CpA_LeftSmall = 307,
    Duid_Steer_CpA_MidZero = 308,
    Duid_Steer_CpA_RightSmall = 309,
    Duid_Steer_CpA_LeftBig = 310,
    Duid_Steer_CpA_RightBig = 311,
    Duid_Steer_CpA_EncoderNumber = 312,
    Duid_Steer_CpA_ActiveStation = 313,
    Duid_Steer_CpA_StationMode = 314,
} ioSystemDataType;
class ioSystemData
{
public:
