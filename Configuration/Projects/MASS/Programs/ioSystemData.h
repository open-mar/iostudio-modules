...
typedef enum
{
    ...
    Duid_Steer_Ap2_RudderAngleMeas = 261,
    Duid_Steer_Ap2_FrontThrustMeas = 262,
    Duid_Steer_Ap2_RateOfTurnMeas = 263,
    Duid_Steer_Ap2_HeadingMeas = 264,
    Duid_Steer_Ap2_FrontThrustRef = 265,
    Duid_Steer_Ap2_OnChangeRef = 266,
    Duid_Steer_Ap2_HeadingRef = 267,
    Duid_Steer_Ap2_RateOfTurnRef = 268,
    Duid_Steer_Ap2_RudderAngleRef = 269,
    Duid_Steer_Ap2_OnRequestSteerData = 270,
    Duid_Steer_Ap2_OnChangeCompass = 271,
    Duid_Steer_Ap2_OnChangeRudder = 272,
    Duid_Steer_Ap2_OnChangeThrust = 273,
    Duid_Steer_Ap2_EngineRpmMeas = 274,
    Duid_Steer_Ap2_EngineRpmRef = 275,
    Duid_Steer_Ap2_OnChangeEngine = 276,
    Duid_Steer_Cp1_TakeCommand = 277,
    Duid_Steer_Cp1_ModeDp = 278,
    Duid_Steer_Cp1_ModeRiver = 279,
    Duid_Steer_Cp1_ModeTrack = 280,
    Duid_Steer_Cp1_ModeWork = 281,
    Duid_Steer_Cp1_ModeAuto = 282,
    Duid_Steer_Cp1_ModeStandby = 283,
    Duid_Steer_Cp1_SteerMode = 284,
    Duid_Steer_Cp1_Release = 285,
    Duid_Steer_Cp1_OnChangeCommand = 286,
    Duid_Steer_Cp1_OnChangeSteerMode = 287,
    Duid_Steer_Cp1_LeftSmall = 288,
    Duid_Steer_Cp1_MidZero = 289,
    Duid_Steer_Cp1_RightSmall = 290,
    Duid_Steer_Cp1_LeftBig = 291,
    Duid_Steer_Cp1_RightBig = 292,
    Duid_Steer_Cp1_EncoderNumber = 293,
    Duid_Steer_Cp2_TakeCommand = 294,
    Duid_Steer_Cp2_ModeDp = 295,
    Duid_Steer_Cp2_ModeRiver = 296,
    Duid_Steer_Cp2_ModeTrack = 297,
    Duid_Steer_Cp2_ModeWork = 298,
    Duid_Steer_Cp2_ModeAuto = 299,
    Duid_Steer_Cp2_ModeStandby = 300,
    Duid_Steer_Cp2_SteerMode = 301,
    Duid_Steer_Cp2_Release = 302,
    Duid_Steer_Cp2_OnChangeCommand = 303,
    Duid_Steer_Cp2_OnChangeSteerMode = 304,
    Duid_Steer_Cp2_LeftSmall = 305,
    Duid_Steer_Cp2_MidZero = 306,
    Duid_Steer_Cp2_RightSmall = 307,
    Duid_Steer_Cp2_LeftBig = 308,
    Duid_Steer_Cp2_RightBig = 309,
    Duid_Steer_Cp2_EncoderNumber = 310,
} ioSystemDataType;
class ioSystemData
{
public:
